...
`enable_default_path` | If this option is enabled, then any files that do not have a specific location to which they should be sent will be sent to the default.
